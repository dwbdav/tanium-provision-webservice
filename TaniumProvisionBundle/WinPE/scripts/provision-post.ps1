...
Write-Output "Starting provision-post.ps1 from tools version $($buildVersion)."

$winTemp = "$($env:SystemRoot)\temp"
$restartRequired = $false

try {
    # Enable the Administrator account only if specified
    $user = Get-LocalUser | Where-Object { $_.SID -like '*-500' }
    Write-Output "Local administrator account name: $($user.Name)"
    if ($EnableLocalAdmin) {
        Write-Output "Ensuring local Administrator account is enabled."
        $user | Enable-LocalUser
        $restartRequired = $true
    } else {
        Write-Output "Ensuring local Administrator account is disabled."
        $user | Disable-LocalUser
    }

    # Set Local Administrator password if specified
    $PasswordFile = "$($winTemp)\EncryptedAdminPassword.clixml"
    if (Test-Path $PasswordFile) {
        $EncryptedAdminPassword = Import-Clixml $PasswordFile

        # Set the password using the value provided.
        Write-Output "Setting the local Administrator password."
        $user | Set-LocalUser -Password $EncryptedAdminPassword
        Remove-Item $PasswordFile -Force
    }
} catch {
    Write-Output "Error in script: $($_.Exception.Message)"
    return $_
} finally {
    if ( $restartRequired ) {
        Write-Output "Restarting computer in 5 seconds."
        # Need to delay, the wrapping script in the scheduled task needs time to clean up after this script exits.
        shutdown -r -t 5
    }
}
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUEQhmYUxjaZdFu5ILz9OWNCry
# 3pKggiDNMIIFjTCCBHWgAwIBAgIQDpsYjvnQLefv21DiCEAYWjANBgkqhkiG9w0B
...
# CSqGSIb3DQEJBDEWBBSNzTv+gVJf9ib57y2C2fAZsupw0zANBgkqhkiG9w0BAQEF
# AASCAYCSxVWqZzoMqOU9Kxac15no+KrmL54mSUCCbvPOC8Psqg2Tm4ncR9zfI0sB
# eBjFIXnTIx3mUDxIguvd1AcH6a34oXlu5JchYmnjZMxs4G1JPMIualiE5kfEO8rJ
# DNOYg1NVlNUBpIkwp3t72u7Qtr26eFCC1ne7KkldaxVaz9M7TvwxRhWYrl5188Ch
# KkUmoOz89L3UpPl/8iVHjFcIACoOefcwVDJhgC0rAhf39KFK75xA4HTPBfMsNGVE
# hlF/py6P/6ctJ0w63h7oMUf97hj7c8NzsEsuuO6TC06j3aNWwCYPcnRllreNYvFa
# ZuqHJ12vtox/yGd0ON+10WDoIqYm9phws14SU79tqfEw6Go5tuJ2FQE5KF6n7FO0
# NAr/+1g4yJbXhBq30KHqAEtJh7Vxo/lDtZZHzNdrUgjA/5f1NwRdBc2JzMcmyOxt
# ybv5UtZp24X/dhWpHxmO+p1yakclGc4NnHAXYVeUc6jgj8VIyIAzEfPZT2YeUQCt
# +Cis5ZihggMmMIIDIgYJKoZIhvcNAQkGMYIDEzCCAw8CAQEwfTBpMQswCQYDVQQG
# EwJVUzEXMBUGA1UEChMORGlnaUNlcnQsIEluYy4xQTA/BgNVBAMTOERpZ2lDZXJ0
# IFRydXN0ZWQgRzQgVGltZVN0YW1waW5nIFJTQTQwOTYgU0hBMjU2IDIwMjUgQ0Ex
# AhAKgO8YS43xBYLRxHanlXRoMA0GCWCGSAFlAwQCAQUAoGkwGAYJKoZIhvcNAQkD
# MQsGCSqGSIb3DQEHATAcBgkqhkiG9w0BCQUxDxcNMjYwNjAxMTgxMDMwWjAvBgkq
# hkiG9w0BCQQxIgQgvXpndJgCUADYK2pBz0BNSlIV6Mj0buBSB2Hz/pMq3E8wDQYJ
# KoZIhvcNAQEBBQAEggIAj3x2zI7TuvI3+Z/bxrq1pljSqlpS8e0qT/hhms1q/EM8
# wSemdglWTkEQ3C5K8o0HjfOwrpI/tE124hFM/HsxxEO8q405HUjznb8vQZ/lfYgp
# Kp/6ZC4cT9mNyWNbZZYM06ul7W0taR8KNZrM8+edsSvfie/fiNVzbR5vp9aWZ48U
# Yr3QsPcYx2B5ifhrygr1VsSJM1ianileNqjAfQEhA6/FRcqlrkfgiNz9I5IOkwGO
# OlMBHFy2nomXo0+UYi99JHvG26Y+tYyM4JqrqDieQR0XPp2JvkTtv2ovcrbRc/6N
# Fuds12QUlMxoqm7NPhroKnbE+689Vr/Ws4TIUCFA+PnMC9i7ZEjhFqW3zlgBqn8Q
# QsfIfbAEBuiF9kioG/F6hNX2r1eQwbaKUa74RadfQmZFHYA9T7lSByxCrSUghG9+
# MJ4lcj42DHQBXquHmVG5QXA+rhk1LQ4L0g6RIr0Sk+Fo+PkvD1F3U6DpV0DwXaQw
# jpe2uo5qOPChxnCO6WbB3Y1AvDD0Xs7ipKPnxHKMAb/E10mAq0p+FxO0fKR7KAMy
# rAFg66dFQulglpDWYLXPjGhoOiAPKZOPjPTnpY/xc6IMS/o29U8y+MeEIz9QTuqc
# kpmi0rFF16e5kpMYGDjJXuHYZbsHb5LjerigUFI8mzID2oJeB1eOYUc1Yp4KP7g=
